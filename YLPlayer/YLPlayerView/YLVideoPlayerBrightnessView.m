...
@interface YLVideoPlayerBrightnessView ()

@property (nonatomic, strong) NSMutableArray *blocksArray;

@end

@implementation YLVideoPlayerBrightnessView
...
- (void)updateBrightnessIndicator:(CGFloat)value {
    ...
    if (self.superview.accessibilityIdentifier) {
        YLVideoPlayerControlView *playerView = (YLVideoPlayerControlView *)self.superview;
